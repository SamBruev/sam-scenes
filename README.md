...
Одностраничное веб-приложение сценария съёмки: в шапке страницы и в метаданных — **CURSOR** (имя воркспейса/чата в Cursor). Продуктовая подпись сценария — **Sam Scenes**. **На GitHub** всё по-прежнему лежит в репозитории **`SamBruev/abakan-script`**, главная страница — это файл **`index.html`** в корне репо (его и публикует GitHub Pages).

- Исходники (источник правды): **`SamScenes/`**
- Копия для выкладки / локальное зеркало: **`abakan-script/`** (тот же `index.html` и ресурсы)
